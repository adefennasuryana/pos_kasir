            ...
            "columns": [
                ...
                },
                {
                  ...
                  render: function (data, type, row) {
                    const status = row.status_bayar;
                    // Kalau type = display → tampilkan warna/label
                    if (type === 'display') {
                      const badgeClass = status === 'Kurang Bayar' ? 'badge-danger' : 'badge-success';
                      return `<span class="badge ${badgeClass}">${status}</span>`;
                    }
                    // type = filter, sort → return plain text agar bisa searchable
                    return status;
                  }
                },
                { "data": "created_at" },
